...
# MUST use the cleaned names — same ones model uses
...
# Debug print
#st.write("Selected A:", teamA)
#st.write("Selected B:", teamB)
...
if st.button("Predict Winner"):
    result = predict(grid_logistic, teamA, teamB)
    team_winner = teamA if result[0][0]==0 else teamB
    conf = result[1][0][result[0][0]]
